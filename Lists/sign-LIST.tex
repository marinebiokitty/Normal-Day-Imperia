...
%%Awakening 2 shiny stuff signs%%

\NEW{Sign}{\sATwoJester}{
  \s\MYname	{Insert Number Here}
  \s\MYloc	{}
  \s\MYtext	{This sign is not in game.}
  \s\MYabils {\aATwoJesterTass{}}
  }
  
%%Other Out of game signs
\NEW{Sign}{\sJestsertass}{
  \s\MYname	{Sign A}
  \s\MYloc	{}
  \s\MYtext	{This sign is not in game.}
  \s\MYitems {\multi{20}{\iJesterTass{}}}
  }
  
%%GameSigns Sleeing\NEW{Sign}{\sJestsertass}{
  \s\MYname	{Fountain}
  \s\MYloc	{}
  \s\MYtext	{There is a fountain here.}
  \s\MYitems {}
  }